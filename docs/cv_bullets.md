...
- Implemented a GitHub Actions reproduction workflow with an OpenFOAM Docker image; the workflow runs `blockMesh`, `checkMesh`, `icoFoam`, validates required outputs, and stores solver logs, CSV summaries, and figures as artifacts.
